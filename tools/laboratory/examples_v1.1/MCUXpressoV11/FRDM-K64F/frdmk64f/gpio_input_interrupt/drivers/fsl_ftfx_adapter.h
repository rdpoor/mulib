...
#if defined(FTFA_FPROTSL_PROTS_MASK) || defined(FTFE_FPROTSL_PROTS_MASK) ||    \
    defined(FTFL_FPROTSL_PROTS_MASK)
...
#if defined(FTFA_FPROTH0_PROT_MASK) || defined(FTFE_FPROTH0_PROT_MASK) ||      \
    defined(FTFL_FPROTH0_PROT_MASK)
...
#if defined(FTFA_FPROTL0_PROT_MASK) || defined(FTFE_FPROTL0_PROT_MASK) ||      \
    defined(FTFL_FPROTL0_PROT_MASK)
...
#elif defined(FTFA_FPROT0_PROT_MASK) || defined(FTFE_FPROT0_PROT_MASK) ||      \
    defined(FTFL_FPROT0_PROT_MASK)
...
#if defined(FSL_FEATURE_FLASH_HAS_MULTIPLE_FLASH) ||                           \
    defined(FSL_FEATURE_FLASH_PFLASH_1_START_ADDRESS)
#if defined(FTFA_FACSSS_SGSIZE_S_MASK) ||                                      \
    defined(FTFE_FACSSS_SGSIZE_S_MASK) || defined(FTFL_FACSSS_SGSIZE_S_MASK)
...
#if (defined(FTFA_FACSS_SGSIZE_MASK) || defined(FTFE_FACSS_SGSIZE_MASK) ||     \
     defined(FTFL_FACSS_SGSIZE_MASK) || defined(FTFA_FACSS_SGSIZE_S_MASK) ||   \
     defined(FTFE_FACSS_SGSIZE_S_MASK) || defined(FTFL_FACSS_SGSIZE_S_MASK))
...
#define FMC_SPECULATION_INVALIDATE(x)                                          \
    (((uint32_t)(((uint32_t)(x)) << INVALID_REG_SHIFT)) & INVALID_REG_MASK)
...
#define FLASH0_FEATURE_PFLASH_START_ADDRESS                                    \
...
#define FLASH0_FEATURE_PFLASH_BLOCK_SECTOR_SIZE                                \
    FSL_FEATURE_FLASH_PFLASH_BLOCK_SECTOR_SIZE
#define FLASH0_FEATURE_PFLASH_BLOCK_WRITE_UNIT_SIZE                            \
...
#define FLASH0_FEATURE_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT                     \
    FSL_FEATURE_FLASH_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT
#define FLASH0_FEATURE_PFLASH_PROTECTION_REGION_COUNT                          \
    FSL_FEATURE_FLASH_PFLASH_PROTECTION_REGION_COUNT
#define FLASH1_FEATURE_PFLASH_START_ADDRESS                                    \
...
#define FLASH1_FEATURE_PFLASH_BLOCK_SECTOR_SIZE                                \
    FSL_FEATURE_FLASH_PFLASH_1_BLOCK_SECTOR_SIZE
#define FLASH1_FEATURE_PFLASH_BLOCK_WRITE_UNIT_SIZE                            \
    FSL_FEATURE_FLASH_PFLASH_1_BLOCK_WRITE_UNIT_SIZE
...
#define FLASH1_FEATURE_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT                     \
...
#define FLASH1_FEATURE_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT                     \
    FSL_FEATURE_FLASH_PFLASH_SECTION_CMD_ADDRESS_ALIGMENT
#endif
#define FLASH1_FEATURE_PFLASH_PROTECTION_REGION_COUNT                          \
    FSL_FEATURE_FLASH_PFLASH_1_PROTECTION_REGION_COUNT
...
#define FLASH1_FEATURE_PFLASH_PROTECTION_REGION_COUNT                          \
    FSL_FEATURE_FLASH_PFLASH_PROTECTION_REGION_COUNT
#else /* undfine FSL_FEATURE_FLASH_HAS_MULTIPLE_FLASH or                       \
         FSL_FEATURE_FLASH_PFLASH_1_START_ADDRESS */
...
#if FLASH0_FEATURE_PFLASH_PROTECTION_REGION_COUNT >                            \
    FLASH1_FEATURE_PFLASH_PROTECTION_REGION_COUNT
#define MAX_FLASH_PROT_REGION_COUNT                                            \
