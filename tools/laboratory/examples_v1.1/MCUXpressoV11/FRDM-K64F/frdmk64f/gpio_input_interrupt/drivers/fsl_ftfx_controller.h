...
enum {
    kStatus_FTFx_Success =
        MAKE_STATUS(kStatusGroupGeneric, 0), /*!< API is executed successfully*/
    kStatus_FTFx_InvalidArgument =
        MAKE_STATUS(kStatusGroupGeneric, 4), /*!< Invalid argument*/
    kStatus_FTFx_SizeError =
        MAKE_STATUS(kStatusGroupFtfxDriver, 0), /*!< Error size*/
    kStatus_FTFx_AlignmentError = MAKE_STATUS(
        kStatusGroupFtfxDriver,
        1), /*!< Parameter is not aligned with the specified baseline*/
    kStatus_FTFx_AddressError =
        MAKE_STATUS(kStatusGroupFtfxDriver, 2), /*!< Address is out of range */
    kStatus_FTFx_AccessError = MAKE_STATUS(
        kStatusGroupFtfxDriver,
        3), /*!< Invalid instruction codes and out-of bound addresses */
    kStatus_FTFx_ProtectionViolation =
        MAKE_STATUS(kStatusGroupFtfxDriver,
                    4), /*!< The program/erase operation is requested to execute
                           on protected areas */
    kStatus_FTFx_CommandFailure =
        MAKE_STATUS(kStatusGroupFtfxDriver,
                    5), /*!< Run-time error during command execution. */
    kStatus_FTFx_UnknownProperty =
        MAKE_STATUS(kStatusGroupFtfxDriver, 6), /*!< Unknown property.*/
    kStatus_FTFx_EraseKeyError =
        MAKE_STATUS(kStatusGroupFtfxDriver, 7), /*!< API erase key is invalid.*/
    kStatus_FTFx_RegionExecuteOnly = MAKE_STATUS(
        kStatusGroupFtfxDriver, 8), /*!< The current region is execute-only.*/
    kStatus_FTFx_ExecuteInRamFunctionNotReady =
        MAKE_STATUS(kStatusGroupFtfxDriver,
                    9), /*!< Execute-in-RAM function is not available.*/
    kStatus_FTFx_PartitionStatusUpdateFailure = MAKE_STATUS(
        kStatusGroupFtfxDriver, 10), /*!< Failed to update partition status.*/
    kStatus_FTFx_SetFlexramAsEepromError = MAKE_STATUS(
        kStatusGroupFtfxDriver, 11), /*!< Failed to set FlexRAM as EEPROM.*/
    kStatus_FTFx_RecoverFlexramAsRamError = MAKE_STATUS(
        kStatusGroupFtfxDriver, 12), /*!< Failed to recover FlexRAM as RAM.*/
    kStatus_FTFx_SetFlexramAsRamError = MAKE_STATUS(
        kStatusGroupFtfxDriver, 13), /*!< Failed to set FlexRAM as RAM.*/
    kStatus_FTFx_RecoverFlexramAsEepromError = MAKE_STATUS(
        kStatusGroupFtfxDriver, 14), /*!< Failed to recover FlexRAM as EEPROM.*/
    kStatus_FTFx_CommandNotSupported = MAKE_STATUS(
        kStatusGroupFtfxDriver, 15), /*!< Flash API is not supported.*/
    kStatus_FTFx_SwapSystemNotInUninitialized =
        MAKE_STATUS(kStatusGroupFtfxDriver,
                    16), /*!< Swap system is not in an uninitialzed state.*/
    kStatus_FTFx_SwapIndicatorAddressError =
        MAKE_STATUS(kStatusGroupFtfxDriver,
                    17), /*!< The swap indicator address is invalid.*/
    kStatus_FTFx_ReadOnlyProperty = MAKE_STATUS(
        kStatusGroupFtfxDriver, 18), /*!< The flash property is read-only.*/
    kStatus_FTFx_InvalidPropertyValue =
        MAKE_STATUS(kStatusGroupFtfxDriver,
                    19), /*!< The flash property value is out of range.*/
    kStatus_FTFx_InvalidSpeculationOption = MAKE_STATUS(
        kStatusGroupFtfxDriver,
        20), /*!< The option of flash prefetch speculation is invalid.*/
    kStatus_FTFx_CommandOperationInProgress =
        MAKE_STATUS(kStatusGroupFtfxDriver,
                    21), /*!< The option of flash command is processing.*/
};
/*@}*/
...
enum _ftfx_driver_api_keys {
    kFTFx_ApiEraseKey = FOUR_CHAR_CODE(
        'k', 'f', 'e',
        'k') /*!< Key value used to validate all FTFx erase APIs.*/
};
/*@}*/
...
typedef enum _ftfx_partition_flexram_load_option {
    kFTFx_PartitionFlexramLoadOptLoadedWithValidEepromData =
        0x00U, /*!< FlexRAM is loaded with valid EEPROM data during reset
                  sequence.*/
    kFTFx_PartitionFlexramLoadOptNotLoaded =
        0x01U /*!< FlexRAM is not loaded during reset sequence.*/
} ftfx_partition_flexram_load_opt_t;

/*!
 * @brief Enumeration for the two possible options of flash read resource
 * command.
 */
typedef enum _ftfx_read_resource_opt {
    kFTFx_ResourceOptionFlashIfr =
        0x00U, /*!< Select code for Program flash 0 IFR, Program flash swap 0
                  IFR, Data flash 0 IFR */
...
typedef enum _ftfx_margin_value {
    ...
    kFTFx_MarginValueUser,    /*!< Apply the 'User' margin to the normal read-1
                                 level.*/
    kFTFx_MarginValueFactory, /*!< Apply the 'Factory' margin to the normal
                                 read-1 level.*/
    kFTFx_MarginValueInvalid  /*!< Not real margin level, Used to determine the
                                 range of valid margin level. */
} ftfx_margin_value_t;
...
typedef enum _ftfx_security_state {
    ...
    kFTFx_SecurityStateBackdoorEnabled =
        (int)0x5aa55aa5u, /*!< Flash backdoor is enabled.*/
    kFTFx_SecurityStateBackdoorDisabled =
        (int)0x5ac33ca5u /*!< Flash backdoor is disabled.*/
} ftfx_security_state_t;

/*!
 * @brief Enumeration for the two possilbe options of set FlexRAM function
 * command.
 */
typedef enum _ftfx_flexram_function_option {
    kFTFx_FlexramFuncOptAvailableAsRam =
        0xFFU, /*!< An option used to make FlexRAM available as RAM */
    kFTFx_FlexramFuncOptAvailableForEeprom =
        0x00U /*!< An option used to make FlexRAM available for EEPROM */
...
typedef enum _ftfx_swap_control_option {
    kFTFx_SwapControlOptionIntializeSystem =
        0x01U, /*!< An option used to initialize the Swap system */
    kFTFx_SwapControlOptionSetInUpdateState =
        0x02U, /*!< An option used to set the Swap in an update state */
    kFTFx_SwapControlOptionSetInCompleteState =
        0x04U, /*!< An option used to set the Swap in a complete state */
    kFTFx_SwapControlOptionReportStatus =
        0x08U, /*!< An option used to report the Swap status */
    kFTFx_SwapControlOptionDisableSystem =
        0x10U /*!< An option used to disable the Swap status */
...
typedef enum _ftfx_swap_state {
    kFTFx_SwapStateUninitialized =
        0x00U, /*!< Flash Swap system is in an uninitialized state.*/
    kFTFx_SwapStateReady = 0x01U, /*!< Flash Swap system is in a ready state.*/
    kFTFx_SwapStateUpdate =
        0x02U, /*!< Flash Swap system is in an update state.*/
    kFTFx_SwapStateUpdateErased =
        0x03U, /*!< Flash Swap system is in an updateErased state.*/
    kFTFx_SwapStateComplete =
        0x04U, /*!< Flash Swap system is in a complete state.*/
    kFTFx_SwapStateDisabled =
        0x05U /*!< Flash Swap system is in a disabled state.*/
} ftfx_swap_state_t;
...
typedef enum _ftfx_swap_block_status {
    kFTFx_SwapBlockStatusLowerHalfProgramBlocksAtZero =
        0x00U, /*!< Swap block status is that lower half program block at
                  zero.*/
    kFTFx_SwapBlockStatusUpperHalfProgramBlocksAtZero =
        0x01U, /*!< Swap block status is that upper half program block at
                  zero.*/
...
typedef struct _ftfx_swap_state_config {
    ...
    ftfx_swap_block_status_t
        currentSwapBlockStatus; /*!< The current Swap block status.*/
    ftfx_swap_block_status_t
        nextSwapBlockStatus; /*!< The next Swap block status.*/
...
#if defined(FSL_FEATURE_FLASH_HAS_FLEX_NVM_ALIAS) &&                           \
    FSL_FEATURE_FLASH_HAS_FLEX_NVM_ALIAS
...
typedef struct _ftfx_ops_config {
    uint32_t
        convertedAddress; /*!< A converted address for the current flash type.*/
    struct {
        uint8_t sectorCmd;
        uint8_t sectionCmd;
        uint8_t resourceCmd;
 ...
 *
 * An instance of this structure is allocated by the user of the flash driver
 * and passed into each of the driver APIs.
 */
typedef struct _ftfx_config {
    ftfx_mem_desc_t flashDesc;
    ftfx_ops_config_t opsConfig;
    uint32_t flexramBlockBase; /*!< The base address of the FlexRAM/acceleration
                                  RAM */
    uint32_t flexramTotalSize; /*!< The size of the FlexRAM/acceleration RAM */
    uint16_t eepromTotalSize; /*!< The size of EEPROM area which was partitioned
                                 from FlexRAM */
    uint16_t reserved;
    function_ptr_t runCmdFuncAddr; /*!< An buffer point to the flash
                                      execute-in-RAM function. */
 ...
 * execution.
 */
status_t FTFx_CMD_Erase(ftfx_config_t *config, uint32_t start,
 ...
 * not available.
 */
status_t FTFx_CMD_EraseSectorNonBlocking(ftfx_config_t *config, uint32_t start,
                                         uint32_t key);
...
/*!
 * @brief Erases all program flash execute-only segments defined by the FXACC
 * registers.
 *
 * @param config Pointer to the storage for the driver runtime state.
 * @param key A value used to validate all flash erase APIs.
 ...
 * @retval #kStatus_FTFx_Success API was executed successfully.
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 * @retval #kStatus_FTFx_AlignmentError Parameter is not aligned with the
 * specified baseline.
 ...
 * execution.
 */
status_t FTFx_CMD_Program(ftfx_config_t *config, uint32_t start,
                          const uint8_t *src, uint32_t lengthInBytes);
 ...
 * given flash area as determined by the index and length.
 *
 * @param config A pointer to the storage for the driver runtime state.
 ...
 * execution.
 */
status_t FTFx_CMD_ProgramOnce(ftfx_config_t *config, uint32_t index,
                              const uint8_t *src, uint32_t lengthInBytes);
 ...
 * @retval #kStatus_FTFx_Success API was executed successfully.
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 * @retval #kStatus_FTFx_AlignmentError Parameter is not aligned with specified
 * baseline.
 * @retval #kStatus_FTFx_AddressError Address is out of range.
 ...
 * requested to execute on protected areas.
 * @retval #kStatus_FTFx_CommandFailure Run-time error during command execution.
 * @retval #kStatus_FTFx_RecoverFlexramAsEepromError Failed to recover FlexRAM
 * as EEPROM.
 */
status_t FTFx_CMD_ProgramSection(ftfx_config_t *config, uint32_t start,
                                 const uint8_t *src, uint32_t lengthInBytes);
#endif /* FSL_FEATURE_FLASH_HAS_PROGRAM_SECTION_CMD */

#if defined(FSL_FEATURE_FLASH_HAS_PROGRAM_PARTITION_CMD) &&                    \
    FSL_FEATURE_FLASH_HAS_PROGRAM_PARTITION_CMD
/*!
 * @brief Prepares the FlexNVM block for use as data flash, EEPROM backup, or a
 * combination of both and initializes the FlexRAM.
 *
 ...
 * @param eepromDataSizeCode Determines the amount of FlexRAM used in each of
 * the available EEPROM subsystems.
 * @param flexnvmPartitionCode Specifies how to split the FlexNVM block between
 * data flash memory and EEPROM backup memory supporting EEPROM functions.
 *
 * @retval #kStatus_FTFx_Success API was executed successfully.
 ...
 * execution.
 */
status_t FTFx_CMD_ReadOnce(ftfx_config_t *config, uint32_t index, uint8_t *dst,
 ...
 * @param option The resource option which indicates which area should be read
 * back.
 *
 * @retval #kStatus_FTFx_Success API was executed successfully.
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 ...
 * execution.
 */
status_t FTFx_CMD_ReadResource(ftfx_config_t *config, uint32_t start,
 ...
 * execution.
 */
status_t FTFx_CMD_VerifyErase(ftfx_config_t *config, uint32_t start,
                              uint32_t lengthInBytes,
...
/*!
 * @brief Verifies whether the program flash execute-only segments have been
 * erased to the specified read margin level.
 *
 * @param config A pointer to the storage for the driver runtime state.
 * @param margin Read margin choice.
 *
 ...
 * @param failedData A pointer to the returned failing data.  Some derivatives
 * do not include failed data as part of the FCCOBx registers.  In this case,
 * zeros are returned upon failure.
 *
 * @retval #kStatus_FTFx_Success API was executed successfully.
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 * @retval #kStatus_FTFx_AlignmentError Parameter is not aligned with specified
 ...
 * execution.
 */
status_t FTFx_CMD_VerifyProgram(ftfx_config_t *config, uint32_t start,
                                uint32_t lengthInBytes,
 ...
 */
    ...
    FSL_FEATURE_FLASH_HAS_SWAP_CONTROL_CMD
/*!
 * @brief Configures the Swap function or checks the swap state of the Flash
 * module.
 *
 * @param config A pointer to the storage for the driver runtime state.
 * @param address Address used to configure the flash Swap function.
 * @param option The possible option used to configure Flash Swap function or
 * check the flash Swap status
 * @param returnInfo A pointer to the data which is used to return the
 * information of flash Swap.
 *
 * @retval #kStatus_FTFx_Success API was executed successfully.
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 * @retval #kStatus_FTFx_AlignmentError Parameter is not aligned with specified
 * baseline.
 * @retval #kStatus_FTFx_SwapIndicatorAddressError Swap indicator address is
 * invalid.
 * @retval #kStatus_FTFx_ExecuteInRamFunctionNotReady Execute-in-RAM function is
 * not available.
 * @retval #kStatus_FTFx_AccessError Invalid instruction codes and out-of bounds
