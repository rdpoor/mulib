...
#define FSL_FLASH_DRIVER_VERSION                                               \
    (MAKE_VERSION(3U, 1U, 2U)) /*!< Version 3.1.2. */

/*! @brief Flash driver version for ROM*/
#define FSL_FLASH_DRIVER_VERSION_ROM                                           \
    (MAKE_VERSION(3U, 0U, 0U)) /*!< Version 3.0.0. */
...
typedef enum _flash_protection_state {
    ...
    kFLASH_ProtectionStateMixed        /*!< Flash is mixed with protected and
                                          unprotected region.*/
} flash_prot_state_t;
...
typedef enum _flash_execute_only_access_state {
    ...
    kFLASH_AccessStateMixed /*!< Flash is mixed with unlimited and execute only
                               region.*/
} flash_xacc_state_t;
...
typedef enum _flash_property_tag {
    kFLASH_PropertyPflash0SectorSize =
        0x00U,                               /*!< Pflash sector size property.*/
    ...
    kFLASH_PropertyPflash0BlockCount =
        0x03U, /*!< Pflash block count property.*/
    kFLASH_PropertyPflash0BlockBaseAddr =
        0x04U, /*!< Pflash block base address property.*/
    kFLASH_PropertyPflash0FacSupport =
        0x05U, /*!< Pflash fac support property.*/
    kFLASH_PropertyPflash0AccessSegmentSize =
        0x06U, /*!< Pflash access segment size property.*/
    kFLASH_PropertyPflash0AccessSegmentCount =
        0x07U, /*!< Pflash access segment count property.*/

    kFLASH_PropertyPflash1SectorSize =
        0x10U,                               /*!< Pflash sector size property.*/
    ...
    kFLASH_PropertyPflash1BlockCount =
        0x13U, /*!< Pflash block count property.*/
    kFLASH_PropertyPflash1BlockBaseAddr =
        0x14U, /*!< Pflash block base address property.*/
    kFLASH_PropertyPflash1FacSupport =
        0x15U, /*!< Pflash fac support property.*/
    kFLASH_PropertyPflash1AccessSegmentSize =
        0x16U, /*!< Pflash access segment size property.*/
    kFLASH_PropertyPflash1AccessSegmentCount =
        0x17U, /*!< Pflash access segment count property.*/

    kFLASH_PropertyFlexRamBlockBaseAddr =
        0x20U, /*!< FlexRam block base address property.*/
 ...
 * number of flash sectors based on the desired start address and length were
 * erased successfully.
 *
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 ...
 *
 * NOTE: This function can only erase one flash sector at a time, and the other
 * commands can be executed after the previous command has been completed.
 *
 * @param config The pointer to the storage for the driver runtime state.
 * @param start The start address of the desired flash memory to be erased.
 *              The start address does not need to be sector-aligned but must be
 ...
 *
 * @retval #kStatus_FTFx_Success API was executed successfully; the all pflash
 * and flexnvm were erased successfully, the swap and eeprom have been reset to
 * unconfigured state.
 *
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 ...
 *
 * @retval #kStatus_FTFx_Success API was executed successfully; the desired data
 * were programed successfully into flash based on desired start address and
 * length.
 *
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 ...
 *        to be programmed. Must be word-aligned.
 *
 * @retval #kStatus_FTFx_Success API was executed successfully; The index
 * indicating the area of program once field was programed successfully.
 *
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 * @retval #kStatus_FTFx_ExecuteInRamFunctionNotReady Execute-in-RAM function is
 * not available.
 ...
 *
 * @retval #kStatus_FTFx_Success API was executed successfully; the desired data
 * have been programed successfully into flash based on start address and
 * length.
 *
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 ...
 * back.
 *
 * @retval #kStatus_FTFx_Success API was executed successfully;  the data have
 * been read successfully from program flash IFR, data flash IFR space, and the
 * Version ID field.
 *
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 * @retval #kStatus_FTFx_AlignmentError Parameter is not aligned with the
 ...
 * @retval #kStatus_FTFx_Success API was executed successfully; the data have
 been successfuly
 *         read form Program flash0 IFR map and Program Once field based on
 index and length.
 ...
 *
 * @retval #kStatus_FTFx_Success API was executed successfully; the specified
 * FLASH region has been erased.
 *
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 * @retval #kStatus_FTFx_AlignmentError Parameter is not aligned with specified
 * baseline.
 ...
 * @param margin Read margin choice.
 *
 * @retval #kStatus_FTFx_Success API was executed successfully; all program
 * flash and flexnvm were in erased state.
 *
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 * @retval #kStatus_FTFx_ExecuteInRamFunctionNotReady Execute-in-RAM function is
 * not available.
 ...
 *
 * @retval #kStatus_FTFx_Success API was executed successfully; the desired data
 * have been successfully programed into specified FLASH region.
 *
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 * @retval #kStatus_FTFx_AlignmentError Parameter is not aligned with specified
 * baseline.
 ...
 * code:
 *
 * @retval #kStatus_FTFx_Success API was executed successfully; the security
 * state of flash was stored to state.
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 */
 ...
 *
 * @retval #kStatus_FTFx_Success API was executed successfully; the FlexRAM has
 * been successfully configured as RAM or EEPROM.
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 * @retval #kStatus_FTFx_ExecuteInRamFunctionNotReady Execute-in-RAM function is
 * not available.
 * @retval #kStatus_FTFx_AccessError Invalid instruction codes and out-of bounds
 ...
 * @param isSetEnable The possible option used to configure the Flash Swap
 * function or check the flash Swap status.
 *
 * @retval #kStatus_FTFx_Success API was executed successfully; the lower half
 * flash and higher half flash have been swaped.
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 * @retval #kStatus_FTFx_AlignmentError Parameter is not aligned with specified
 * baseline.
 ...
 * requested to execute on protected areas.
 * @retval #kStatus_FTFx_CommandFailure Run-time error during command execution.
 * @retval #kStatus_FTFx_SwapSystemNotInUninitialized Swap system is not in an
 * uninitialized state.
 */
 ...
 *
 * @param config A pointer to the storage for the driver runtime state.
 * @param start The start address of the desired flash memory to be checked.
 * Must be word-aligned.
 * @param lengthInBytes The length, given in bytes (not words or long-words)
 ...
 *
 * @retval #kStatus_FTFx_Success API was executed successfully; the protection
 * state of specified FLASH region was stored to protection_state.
 *
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 * @retval #kStatus_FTFx_AlignmentError Parameter is not aligned with specified
 * baseline.
 ...
 *
 * @retval #kStatus_FTFx_Success API was executed successfully; the executeOnly
 * state of specified FLASH region was stored to access_state.
 *
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 * @retval #kStatus_FTFx_AlignmentError The parameter is not aligned to the
 * specified baseline.
 * @retval #kStatus_FTFx_AddressError The address is out of range.
 */
 ...
 *
 * @retval #kStatus_FTFx_Success API was executed successfully; the Protection
 * state was stored to protectStatus;
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
 */
 ...
 *
 * @retval #kStatus_FTFx_Success API was executed successfully; the flash
 * property was stored to value.
 * @retval #kStatus_FTFx_InvalidArgument An invalid argument is provided.
