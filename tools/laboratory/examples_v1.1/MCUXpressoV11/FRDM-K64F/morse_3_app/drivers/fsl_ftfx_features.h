...
#if (defined(BL_TARGET_FLASH) || defined(BL_TARGET_ROM) ||                     \
...
#define FTFx_DRIVER_IS_FLASH_RESIDENT                                          \
    1U /*!< Used for the flash resident application. */
#else
#define FTFx_DRIVER_IS_FLASH_RESIDENT                                          \
    0U /*!< Used for the non-flash resident application. */
#endif
#endif
...
#else
#define FTFx_DRIVER_IS_EXPORTED                                                \
    0U /*!< Used for the MCUXpresso SDK application. */
#endif
#endif
/*@}*/

/*! @brief Indicates whether the secondary flash is supported in the Flash
 * driver */
#if defined(FSL_FEATURE_FLASH_HAS_MULTIPLE_FLASH) ||                           \
    defined(FSL_FEATURE_FLASH_PFLASH_1_START_ADDRESS)
 ...
 * in flash module. */
#if defined(FSL_FEATURE_FLASH_HAS_MULTIPLE_FLASH) &&                           \
    defined(FTFE_FPROTS_PROTS_MASK)
#define FTFx_FLASH1_HAS_PROT_CONTROL (1U)
#else
#define FTFx_FLASH1_HAS_PROT_CONTROL (0U)
#endif

/*! @brief Indicates whether the secondary flash has its own Execute-Only access
 * register in flash module. */
#if defined(FSL_FEATURE_FLASH_HAS_MULTIPLE_FLASH) &&                           \
    defined(FTFE_FACSSS_SGSIZE_S_MASK)
