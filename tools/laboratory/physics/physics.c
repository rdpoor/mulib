...
position_t reflect(position_t p, position_t wall) { return 2 * wall - p; }
...
void print_ball(ball_t *b, collision_t c) {
    ...
    case COLLISION_NONE:
        s = "COLLISION_NONE";
        break;
    case COLLISION_WALL_TOP:
        s = "COLLISION_WALL_TOP";
        break;
    case COLLISION_WALL_BOTTOM:
        s = "COLLISION_WALL_BOTTOM";
        break;
    case COLLISION_WALL_LEFT:
        s = "COLLISION_WALL_LEFT";
        break;
    case COLLISION_WALL_RIGHT:
        s = "COLLISION_WALL_RIGHT";
        break;
    case COLLISION_PADDLE_LEFT:
        s = "COLLISION_PADDLE_LEFT";
        break;
    case COLLISION_PADDLE_RIGHT:
        s = "COLLISION_PADDLE_RIGHT";
        break;
    case GRAZE_PADDLE_LEFT:
        s = "GRAZE_PADDLE_LEFT";
        break;
    case GRAZE_PADDLE_RIGHT:
        s = "GRAZE_PADDLE_RIGHT";
        break;
    default:
        s = "COLLISION_UNKNOWN";
        break;
    }
    printf("b: x=%d, y=%d, dx=%d, dy=%d: %s\n", b->x, b->y, b->dxdt, b->dydt,
           s);
}
